...
void iInitialize(int width = 500, int height = 500, char *title = "iGraphics", int freeConsole = 0, int fullscreen = 0) {
	...
	if (!fullscreen) glutReshapeFunc(resizeHandle);
	else  glutFullScreen();
